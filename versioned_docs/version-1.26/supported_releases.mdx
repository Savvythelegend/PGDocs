...
_This page lists the status, timeline and policy for currently supported
releases of CloudNativePG_.
...
[preview testing](preview_version.mdx).
...
| Release Candidate | No support                                                                                                               | [Preview version: Not production-ready](preview_version.mdx). Released for experimentation and testing.        |
...
the [release notes](release_notes.mdx).
...
_"Does this backport improve `CloudNativePG`, bearing in mind that we really
value stability for already-released versions?"_
