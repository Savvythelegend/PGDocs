...
```sh
curl -sSfL \
  https://github.com/cloudnative-pg/cloudnative-pg/raw/main/hack/install-cnpg-plugin.sh | \ sudo sh -s -- -b /usr/local/bin ```
|  |
...
```console
$ kubectl cnpg logs cluster cluster-example | kubectl cnpg logs pretty --pods cluster-example-1 --loggers postgres --log-level info 2024-10-15T17:35:00.509 INFO     cluster-example-1 postgres         2024-10-15 17:35:00.509 UTC [29] LOG:  redirecting log output to logging collector process 2024-10-15T17:35:00.509 INFO     cluster-example-1 postgres         2024-10-15 17:35:00.509 UTC [29] HINT:  Future log output will appear in directory "/controller/log"... 2024-10-15T17:35:00.510 INFO     cluster-example-1 postgres         2024-10-15 17:35:00.509 UTC [29] LOG:  ending log output to stderr 2024-10-15T17:35:00.510 INFO     cluster-example-1 postgres         ending log output to stderr [...] ```
|  |
...
:::info
For more details, see the ["Declarative Hibernation"](declarative_hibernation.mdx)
documentation page.
...
Refer to the [Benchmarking pgbench section](benchmarking.mdx#pgbench) for more
details.
...
Refer to the [Benchmarking fio section](benchmarking.mdx#fio) for more details.
...
The ["Backup" section](./backup.mdx#backup) contains more information about
...
applications to the new database (_cutover_).
