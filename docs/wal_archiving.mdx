...
defined via the [`spec.pluginConfiguration`](cloudnative-pg.v1.mdx#postgresql-cnpg-io-v1-ClusterSpec)
...
your Recovery Point Objective ([RPO](before_you_start.mdx#rpo)).
