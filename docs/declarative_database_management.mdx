...
is explained in the ["Bootstrap an Empty Cluster"](bootstrap.mdx#bootstrap-an-empty-cluster-initdb)
section.
...
:::info
Please refer to the [API reference](cloudnative-pg.v1.mdx#postgresql-cnpg-io-v1-DatabaseSpec)
...
- `name` _(mandatory)_: The name of the extension.
...
To address this, the ["managed extensions"](postgresql_conf.mdx#managed-extensions)
...
- `name` _(mandatory)_: The name of the schema.
