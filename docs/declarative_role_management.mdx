...
This process is described in the ["Bootstrap"](bootstrap.mdx) section.
...
creation will occur _after_ the database bootstrapping is complete.
...
Please refer to the [API reference](cloudnative-pg.v1.mdx#postgresql-cnpg-io-v1-RoleConfiguration) for
...
The [kubectl plugin](kubectl-plugin.mdx) also shows the status of managed roles
