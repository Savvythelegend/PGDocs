...
[`managed.services.disabledDefaultServices` option](cloudnative-pg.v1.mdx#postgresql-cnpg-io-v1-ManagedServices).
...
[`managed.services.additional` stanza](cloudnative-pg.v1.mdx#postgresql-cnpg-io-v1-ManagedService)
