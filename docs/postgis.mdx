...
operand. The ["Container Image Requirements" section](container_images.mdx) provides
...
please refer to the ["How many databases should be hosted in a single PostgreSQL instance?" FAQ](faq.mdx)
or the ["Database import" section](database_import.mdx).
...
["Managing Extensions in a Database" section](declarative_database_management.mdx#managing-extensions-in-a-database).
...
| ----- | ----- |
 ...
 postgis_topology-3       | 3.5.2           |                   | PostGIS topology spatial types and functions (10 rows) ```
...
| ----- | ----- |
 ...
 postgis_topology       | 3.5.2   | topology   | PostGIS topology spatial types and functions (5 rows) ```
